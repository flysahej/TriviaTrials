...
public class DrawMaze extends JFrame {
    ...
    public DrawMaze(String labFile) {
        ...
        try {
            ...
            try {
                ...
                name = "personb.gif";
                System.out.println("Loading " + name);
                imgb = ImageIO.read(new File(name));
                System.out.println("Loaded " + name);

                name = "rock3.jpg";
                System.out.println("Loading " + name);
                rock = ImageIO.read(new File(name));
                System.out.println("Loaded " + name);
            ...
            else display.drawString("Available coins: " + Integer.toString(coins), offset, 2 * labLength * roomSize + offsety);
    ...
    private void drawEdge(int u, int v) {
        ...
        if (imageFile)
            erasePerson((us % labWidth) * 2 * roomSize, (us / labWidth) * 2 * roomSize);
    ...
    private void drawPerson(int x, int y, boolean right) {
        ...
        if ((x == (endx * roomSize)) && (y == (endy * roomSize))) {
            if (right)
                display.drawImage(img, x + 2 * roomSize / 5, y + roomSize / 5, x + 4 * roomSize / 5, y + 4 * roomSize / 5, 1, 1, img.getWidth(), img.getHeight(), null);
            else
                display.drawImage(imgb, x + 2 * roomSize / 5, y + roomSize / 5, x + 4 * roomSize / 5, y + 4 * roomSize / 5, 1, 1, img.getWidth(), img.getHeight(), null);
        } else {
            if (right)
                display.drawImage(img, x + offset, y + offset, x + roomSize - offset, y + roomSize - offset, 1, 1, img.getWidth(), img.getHeight(), backColor, null);
            else
                display.drawImage(imgb, x + offset, y + offset, x + roomSize - offset, y + roomSize - offset, 1, 1, img.getWidth(), img.getHeight(), backColor, null);
        }
    }
    ...
    private void drawStart(int x, int y) {
        ...
        display.fillRect(x * roomSize + 2 * roomSize / 5, y * roomSize + roomSize / 5, 2 * roomSize / 5, 3 * roomSize / 5);
        int[] xcoor = {x * roomSize + 2 * roomSize / 5, x * roomSize + roomSize / 5, x * roomSize + roomSize / 5, x * roomSize + 2 * roomSize / 5};
        int[] ycoor = {y * roomSize + roomSize / 5, y * roomSize + roomSize / 10, y * roomSize + 7 * roomSize / 10, y * roomSize + 4 * roomSize / 5};
        display.setColor(door);
        display.fillPolygon(xcoor, ycoor, 4);
        display.setColor(wallColor);
        display.fillOval(x * roomSize + 2 * roomSize / 10, y * roomSize + 4 * roomSize / 10, roomSize / 10, roomSize / 10);
    }
    ...
    private void drawRock(int x, int y) {
        display.drawImage(rock, x * roomSize, y * roomSize, (x + 1) * roomSize, (y + 1) * roomSize, 1, 1, rock.getWidth(), rock.getHeight(), null);
    }
    ...
    private void drawHorHall(int x, int y) {
        ...
        display.drawImage(rock, x * roomSize, y * roomSize, (x + 1) * roomSize, y * roomSize + roomSize / 5, 1, 1, rock.getWidth(), rock.getHeight(), null);
        display.drawImage(rock, x * roomSize, y * roomSize + 4 * roomSize / 5, (x + 1) * roomSize, (y + 1) * roomSize, 1, 1, rock.getWidth(), rock.getHeight(), null);
    }
    ...
    private void drawVerHall(int x, int y) {
        ...
        display.drawImage(rock, x * roomSize, y * roomSize, x * roomSize + roomSize / 5, (y + 1) * roomSize, 1, 1, rock.getWidth(), rock.getHeight(), null);
        display.drawImage(rock, x * roomSize + 4 * roomSize / 5, y * roomSize, (x + 1) * roomSize, (y + 1) * roomSize, 1, 1, rock.getWidth(), rock.getHeight(), null);
    }
